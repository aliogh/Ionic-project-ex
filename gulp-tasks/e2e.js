...
module.exports = function (gulp, plugins, config, args) {
    ...
    return function() {
        ...
        if (args.standalone) {
            ...
            plugins.run('screen -d -m -L ionic serve --port ' + protarctorPort + ' --nolivereload --nobrowser').exec();

            protractorArgs = ['--baseUrl', 'http://127.0.0.1:' + protarctorPort + '?ionicplatform=android'];
